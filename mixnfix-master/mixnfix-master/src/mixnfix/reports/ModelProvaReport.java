...
private static String fillLeft(String s, int size, char ch) {
    ...
    public static String getTrechoRelatorioPDFLaTeX(ModelProva modelProva, Date date) throws Exception {
        ...
        report.append("{\\bf \\Large Instituição} \\> {\\bf \\Large :} \\> {\\bf \\Large " +  modelProva.getProva().getInstituicao_Prova().getNome() + "} \\\\\n");
        ...
        report.append("{\\bf \\Large Correções} \\label{" + correcoesLink + "}\n");
