 ...
 * ferentes.
 */
public class FolhaRespostaQuestionarioBasico implements IFolhaResposta {
    ...
    public static final double GRAY_FILL = 1f;   // milimeters

    private static final double MARGIN        = 0f;   // milimeters
    private static final double WIDTH         = 190f; // width
    private static final double HEIGHT        = 270f; // height
    public static final  double PAPER_WIDTH   = 210f;  // milimeters
    public static final  double PAPER_HEIGHT  = 297f;  // milimeters
    private static final double X0            = (PAPER_WIDTH-WIDTH)/2.0f;   // top left 4-target corner X
    private static final double Y0            = (PAPER_HEIGHT-HEIGHT)/2.0f; // top left 4-target corner Y

    public static final double CELL_DIAMETER = 3f; // milimeters

    public static final double GAP_CONTROLO_QUESTOES = 2.5f; // milimeters

    public static final double CP_SIZE = 2.4f; // size of control point

    public static final double WIDTH_COLUNA_CONTROLE = 5f; // size of control point
    public static final double WIDTH_COLUNA_CONTROLE_MIDDLE = 8f; // size of control point

    private static final double WIDTH_UTIL_COLUMN        = (WIDTH-2*WIDTH_COLUNA_CONTROLE-WIDTH_COLUNA_CONTROLE_MIDDLE)/2.0f;     // width
    private static final double X0_COLUMN_1              = X0 + WIDTH_COLUNA_CONTROLE;     // width
    private static final double X0_COLUMN_2              = X0 + WIDTH - WIDTH_COLUNA_CONTROLE - WIDTH_UTIL_COLUMN;     // width

    public FolhaRespostaQuestionarioBasico(ProvaStructure prova) {
        _prova = prova;
    ...
    public String getName() {
        return "Folha Básica para Questionário ";
    }
    ...
    public String getDescription() {
        return "Folha de resposta básica para questionário.\n" +
               "As células têm diâmetro de 3mm, o que dá, numa.\n"+
               "resoluçao de 640x480, 20 pixels por célula.\n";
    }

    /**
     * Nao importa o tipo para inicializar folha de resposta
     * para questionario!
     */
    ...
    private void inicializarHardWork() {
        ...
        List<Quesito> quesitos = _prova.getQuesitos();
        int numQuesito = 1;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Controller.unzip("C:/pesquisa.prova", Controller.TMP_DIR);
        ...
        FolhaRespostaQuestionarioBasico g = new FolhaRespostaQuestionarioBasico(prova);
        g.inicializarQuesitos();

        // MultiCampo id = g.getCellMap().getMultiCampo(CellMap.MULTICAMPO_ID);
        //id.setValor(new int[] {0,2,5,6,7,0,6,2,4,7,5});

        PrintWriter pw = new PrintWriter(new FileOutputStream("c:/pesquisa.eps"));
    ...
    class FRNumerico extends FRBloco {
        ...
        private static final double CELL_DIAMETER          = FolhaRespostaQuestionarioBasico.CELL_DIAMETER; // milimeters
        ...
        public void writeEPS(PrintWriter pw) throws IOException {
            ...
            pw.println("closepath");
            pw.println(String.format("%.4f setgray",FolhaRespostaQuestionarioBasico.GRAY_FILL));
            pw.println("gsave fill grestore");
...
//        pw.println("("+(char)(Character.valueOf('A')+i)+") dup stringwidth pop 2 div neg 0 rmoveto show");
    ...
    class FRColunaControle extends FRBloco {
        ...
        private double _gap;
        private static final double CP_SIZE = FolhaRespostaQuestionarioBasico.CP_SIZE; // milimeters
            ...
            while (y < this.getHeight()) {
                double xx = (_alignment == CENTER_ALIGNMENT ?
                            ...
                            (_alignment == LEFT_ALIGNMENT ?
                                getX0() :
                                getX0() + getWidth() ));
                FolhaRespostaQuestionarioBasico.writeEPSControlPoint(pw, xx, getY0() + y + CP_SIZE / 2.0f);
                y += _gap;
            }
        }
    ...
    class FRQuesitoAlternativas extends FRBloco {
        private static final double BOX_MARGIN = 1f; // milimeters
...
//        pw.println("("+(char)(Character.valueOf('A')+i)+") dup stringwidth pop 2 div neg 0 rmoveto show");
    ...
    class FRQuesitoVerdadeiroFalso extends FRBloco {
        private static final double BOX_MARGIN = 1f; // milimeters
...
//        pw.println("("+(char)(Character.valueOf('A')+i)+") dup stringwidth pop 2 div neg 0 rmoveto show");
    ...
    class FRSubjetiva extends FRBloco {
        private static final double BOX_MARGIN = 1f; // milimeters
